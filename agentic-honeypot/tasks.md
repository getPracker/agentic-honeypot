...
- [ ] 4. Implement Scam Detection engine
  - [ ] 4.1 Create basic scam detection logic
  ...
  - [ ] 4.2 Add non-scam handling and classification
  ...
  - [ ]* 4.5 Write unit tests for scam type detection
